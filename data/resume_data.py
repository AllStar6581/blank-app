...
""",
        ...
        "responsibilities": [
            ...
            "Architecture design, API contract definition, and data model ownership.",
            "Building the LLM assistant with function calling and video context capabilities.",
            "Production deployment, monitoring, and ongoing support.",
            "Tech lead responsibilities: requirements definition, client and designer engagement, UX alignment, and feature prioritization.",
        ],
        "skills": [
            ...
            {"name": "Video analysis", "category": "AI & ML"},
            {"name": "Tech leadership", "category": "Leadership & soft skills"},
            {"name": "Client communication", "category": "Leadership & soft skills"},
            {"name": "Requirements definition", "category": "Leadership & soft skills"},
...
""",
        ...
        "responsibilities": [
            ...
            "Designing and building the RAG system with an AI assistant and semantic search engine.",
            "Documenting architecture using Archimate and C4 models for team alignment and stakeholder communication.",
            "Setting up and maintaining CI/CD pipelines and delivery infrastructure.",
            "Defining engineering processes, branching strategy, and release management.",
        ],
        "skills": [
